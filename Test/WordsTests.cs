...
public class OneWordsTests
{
    ...
    public void OneWord_OneOption_AllGreen()
    {
        ...
        var (preferred, _, _) = words.Suggest(new Word(new('a', Green), new('s', None), new('t', None), new('r', None), new('o', Green))); // astro
    ...
    public void OneWord_TwoOptions_AllGreen()
    {
        ...
        var (preferred, _, _) = words.Suggest(new Word(new('p', Green), new('o', None), new('r', None), new('c', None), new('a', None))); // porca
    ...
    public void OneWorld_ThreeWords_AllGreen()
    {
        ...
        var (preferred, others, _) = words.Suggest(new Word(new('a', Green), new('b', Green), new('a', Green), new('f', None), new('a', Green))); // abafa
    ...
    {
        var words = new Words("pt-BR", new[] { "abada", "abade", "abado" });
        var (preferred, others, _) = words.Suggest(new Word(new('a', Green), new('b', Green), new('a', Green), new('d', Green), new('a', None))); // abada
        preferred.ShouldBeEmpty();
    ...
    {
        var words = new Words("pt-BR", new[] { "abada", "abade", "abado" });
        var (preferred, others, _) = words.Suggest(new Word(new('a', Green), new('b', Green), new('a', Green), new('f', None), new('a', None))); // abafa
        preferred.ShouldBeEmpty();
        others.ShouldBe(new[] { "abade", "abado" }, Case.Sensitive);
    }
    ...
    {
        var words = new Words("pt-BR", new[] { "abada", "abade", "abado" });
        var (preferred, others, _) = words.Suggest(new Word(new('a', Green), new('b', Green), new('o', Yellow), new('l', None), new('i', None))); // aboli
        preferred.ShouldBeEmpty();
    ...
    public void OneWorld_ThreeWords_GreensAndYellows_YellowInGreenPosition()
    {
        ...
        var (preferred, others, _) = words.Suggest(new Word(new('a', Green), new('b', Green), new('a', Yellow), new('f', None), new('o', Yellow))); // abafo
        preferred.ShouldBeEmpty();
    ...
    public void ExcludePreviousWrongLetters()
    {
        ...
        var (preferred, _, _) = words.Suggest(new Word(new('a', Green), new('b', Green), new('d', None), new('a', None), new('l', None))); // abdal
    ...
    public void PreferredLettersMaximizeResult()
    {
        ...
        var (preferred, others, _) = words.Suggest(new Word(new('a', Green), new('b', Green), new('c', None), new('d', None), new('e', None))); // abcde
        preferred.ShouldBe(new[] { "abijk", "abmno", "abrst" }, Case.Sensitive);
        others.ShouldBe(new[] { "ababa", "ababf" }, Case.Sensitive);
    }

    [Fact]
    public void UnmatchedShowUnrelatedWords()
    {
        var words = new Words("pt-BR", new[] { "abhij", "xycde", "ffghi", "fghij", "klmno", "pqrst" });
        var (_, _, unmatched) = words.Suggest(new Word(new('a', Green), new('b', Green), new('c', None), new('d', None), new('e', None))); // abcde
        unmatched.ShouldBe(new[] { "fghij", "klmno", "pqrst" }, Case.Sensitive);
    }
}
...
public class TwoWordsTests
{
    ...
    public void TwoWorlds_ThreeWords_Greens()
    {
        ...
        var (preferred1, others1, _) = words.Suggest(new Word(new('a', Green), new('b', Green), new('a', Green), new('f', None), new('o', None))); // abafo
        preferred1.ShouldBeEmpty();
        others1.ShouldBe(new[] { "abada", "abade" }, Case.Sensitive);
        var (preferred2, others2, _) = words.Suggest(new Word(new('a', Green), new('b', Green), new('a', Green), new('n', None), new('e', None))); // abane
